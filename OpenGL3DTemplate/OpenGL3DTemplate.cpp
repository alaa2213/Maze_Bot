...
// Level 1 Simplified Maze Layout - Fewer walls with MUCH WIDER corridors
const int NUM_WALLS_L1 = 10;
float wallPositionsL1[10][2] = {
    // Left side boundary walls (wider spacing)
    {-8.0f, 6.0f},    // Upper left
    {-8.0f, 0.0f},    // Middle left
    {-8.0f, -6.0f},   // Lower left
    
    // Right side boundary walls (wider spacing)
    {8.0f, 6.0f},     // Upper right
    {8.0f, 0.0f},     // Middle right
    {8.0f, -6.0f},    // Lower right
    
    // Strategic center obstacles (very wide spacing)
    {-3.0f, 3.0f},    // Upper left inner
    {3.0f, 3.0f},     // Upper right inner
    {-3.0f, -3.0f},   // Lower left inner
    {3.0f, -3.0f}     // Lower right inner
};
...
void display() {
    ...
    if (currentLevel == 1) {
        ...
        // Set baby blue color for ice walls to override the model's red color
        glColor3f(0.54f, 0.81f, 0.94f); // Baby blue color
        ...
        // Reset color to white after drawing ice walls
...
void keyboard(unsigned char key, int x, int y) {
    ...
    if (!isTransitioning) {
        ...
        int numWalls = (currentLevel == 1) ? NUM_WALLS_L1 : NUM_WALLS_L2;
